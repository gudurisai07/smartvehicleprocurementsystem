...
urlpatterns = [
    ...
    path('userDetails/<str:user_type>/<int:user_id>/', av.userDetailsView, name='userDetails'),
    ...
    # Password Reset URLS
    path('forgot-password', bv.forgot_password_request, name='forgot_password_request'),
    path('verify-otp', bv.verify_otp, name='verify_otp'),
    path('reset-password', bv.reset_password_final, name='reset_password_final'),
    path('send-registration-otp/', bv.send_registration_otp, name='send_registration_otp'),
    path('verify-registration-otp-ajax/', bv.verify_registration_otp_ajax, name='verify_registration_otp_ajax'),
]
